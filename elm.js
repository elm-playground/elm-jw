...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var input = function () {
      var delta = A2($Signal.map,function (t) {    return t / 20;},$Time.fps(100));
   ...
   var view = F2(function (_p0,mario) {
      ...
      "../imgs/mario/",
      A2($Basics._op["++"],verb,A2($Basics._op["++"],"/",A2($Basics._op["++"],dir,_U.eq(verb,"jump") ? ".png" : ".png"))));
      var marioImage = A3($Graphics$Element.image,130,130,src);
   ...
   var gravity = F2(function (dt,mario) {    return _U.update(mario,{vy: _U.cmp(mario.y,0) > 0 ? mario.vy - dt / 2 : 0});});
   var jump = F2(function (keys,mario) {    return _U.cmp(keys.y,0) > 0 && _U.eq(mario.vy,0) ? _U.update(mario,{vy: 20.0}) : mario;});
