...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var main = A2($Svg.svg,
   _U.list([$Svg$Attributes.version("1.1"),$Svg$Attributes.x("0"),$Svg$Attributes.y("0"),$Svg$Attributes.viewBox("0 0 323.141 322.95")]),
   _U.list([A2($Svg.polygon,_U.list([$Svg$Attributes.fill("#F0AD00"),$Svg$Attributes.points("161.649,152.782 231.514,82.916 91.783,82.916")]),_U.list([]))
           ,A2($Svg.polygon,_U.list([$Svg$Attributes.fill("#7FD13B"),$Svg$Attributes.points("8.867,0 79.241,70.375 232.213,70.375 161.838,0")]),_U.list([]))
           ,A2($Svg.rect,
           ...
           _U.list([]))
           ,A2($Svg.polygon,_U.list([$Svg$Attributes.fill("#60B5CC"),$Svg$Attributes.points("323.298,143.724 323.298,0 179.573,0")]),_U.list([]))
           ,A2($Svg.polygon,_U.list([$Svg$Attributes.fill("#5A6378"),$Svg$Attributes.points("152.781,161.649 0,8.868 0,314.432")]),_U.list([]))
           ,A2($Svg.polygon,_U.list([$Svg$Attributes.fill("#F0AD00"),$Svg$Attributes.points("255.522,246.655 323.298,314.432 323.298,178.879")]),_U.list([]))
           ,A2($Svg.polygon,_U.list([$Svg$Attributes.fill("#60B5CC"),$Svg$Attributes.points("161.649,170.517 8.869,323.298 314.43,323.298")]),_U.list([]))]));
